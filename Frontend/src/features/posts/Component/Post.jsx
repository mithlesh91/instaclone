...
const Post = ({ user, posts, loading, likehandle, unlikehandle, followhandle, unfollowhandle }) => {
    return (
        <div>
            <div className="feed-container">
                ...
                <div className="profile">
                    ...
                    <div className="folws">
                        {posts.isFollow ? (
                            <button onClick={() => unfollowhandle(user.username)}>
                                Unfollow
                            </button>
                        ) : (
                            <button onClick={() => followhandle(user.username)}>
                                Follow
                            </button>
                        )}
                    </div>
                ...
                <div className="post-image">
                    <img src={posts.image_url} alt="error-postimage" />
                </div>
                <div className="icon">
                    <div className="left-icone">
                        <button><svg className={posts.isLiked ? "isLiked" : ""}
                            onClick={() => { posts.isLiked ? unlikehandle(posts._id) : likehandle(posts._id) }}
                ...
                <div className="caption">
                    <p><strong>{user.username}</strong> {posts.caption} 🌤️</p>
                </div>
            </div>
        </div>
    )
